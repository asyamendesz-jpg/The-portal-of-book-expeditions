  ...
  global.ReadingPortal.fieldTasks = [
    {
      ...
      prompt: 'Нарисуй, как ты представляешь неизвестную планету, на которую могла бы попасть Алиса.',
      hint: 'Можно использовать карандаши, фломастеры, краски или любые материалы, которые есть дома.',
