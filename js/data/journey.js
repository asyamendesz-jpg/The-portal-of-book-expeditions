(function (global) {
  ...
  global.ReadingPortal.journeySteps = [
    ...
    },
    {
      id: 'field',
      short: 'Руками',
      title: 'Полевое задание',
      href: 'field-task.html',
      flag: 'fieldTaskCompleted',
      doneLabel: 'Сделал полевое задание'
    },
    {
      id: 'diary',
      short: 'Дневник',
      title: 'Дневник экспедиции',
      href: 'diary.html',
      flag: 'diaryViewed',
      doneLabel: 'Открыл дневник экспедиции'
    },
    {
      id: 'achievements',
      short: 'Награда',
  ...
  global.ReadingPortal.journeyNextCopy = {
    ...
    card: {
      title: 'Все карточки собраны!',
      text: 'Теперь выйди из экрана — сделай полевое задание руками.',
      cta: 'К полевому заданию →',
      nextId: 'field'
    },
    field: {
      title: 'Полевое задание выполнено!',
      text: 'Запись появилась в Дневнике экспедиции.',
      cta: 'Открыть Дневник →',
      nextId: 'diary'
    },
    diary: {
      title: 'Дневник обновлён!',
      text: 'Пора посмотреть достижения экспедиции.',
      cta: 'Посмотреть достижения →',
      nextId: 'achievements'
    },
    achievements: {
