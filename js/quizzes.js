(function () {
  ...
  function renderHowItWorks(container) {
    ...
    block.innerHTML =
      ...
      '<li class="quiz-how__item"><strong>Играй</strong> — пройди испытания на сайте.</li>' +
      '<li class="quiz-how__item"><strong>Дополнительно</strong> — PDF можно скачать отдельно, если нужно.</li>' +
      '</ol>';
